namespace Forum.App.Views
{
    ...
    public class CategoryView : IView
    {
        ...
        private void InitializeButtons(Position consoleCenter)
        {
            ...
            var categoryButtonPositions = new Position[]
            {
            ...
            for (int i = 0; i < categoryButtonPositions.Length; i++)
            {
                ...
                ILabel label =
                    new Label(currentCategoryName, categoryButtonPositions[i], currentCategoryName == string.Empty);
        ...
        {
            string[] labelContent =
                new string[] { string.Format("CATEGORY: {0}", this.categoryName), "Title", /*"Replies"*/ };
